...
@NgModule({
  declarations: [AdminAllComponent, CourseItemComponent, CreateCourseComponent,CourseDetailsComponent, CourseCatalogComponent, CompanyProfileComponent, EditCourseComponent, DeleteDialogComponent, DialogElementsComponent, SpinnerComponent, CourseStreamComponent],
  imports: [
    CommonModule,
    ReactiveFormsModule,
    HttpClientModule,
