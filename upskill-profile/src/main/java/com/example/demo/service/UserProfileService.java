...
public interface UserProfileService {
    ...
    UserProfileView editUserProfile(String email, UserProfileEditBindingModel userProfile) throws IOException;
    ...
    List<EmployeeBindingModel> getAllEmployeesByBusinessOwner(HttpServletRequest request);
}
