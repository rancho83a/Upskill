...
public class UserProfileServiceImpl implements UserProfileService {
    ...
    @Override
    public List<EmployeeBindingModel> getAllEmployeesByBusinessOwner(HttpServletRequest request) {
        ...
        UserProfileEntity[] entityList = this.userProfileRepository.getEmployeesByBusinessOwner(companyId,companyOwnerEmail);
         return Arrays.asList(this.modelMapper.map(entityList,EmployeeBindingModel[].class));
    ...
    @Override
    public UserProfileView editUserProfile(String email, UserProfileEditBindingModel userProfile) throws IOException {
